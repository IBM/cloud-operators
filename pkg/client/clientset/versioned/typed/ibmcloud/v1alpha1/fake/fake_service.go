...
type FakeServices struct {
	Fake *FakeIbmcloudV1alpha1
	ns   string
}

var servicesResource = schema.GroupVersionResource{Group: "ibmcloud.ibm.com", Version: "v1alpha1", Resource: "services"}

var servicesKind = schema.GroupVersionKind{Group: "ibmcloud.ibm.com", Version: "v1alpha1", Kind: "Service"}
