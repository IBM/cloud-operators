...
var bindingsResource = schema.GroupVersionResource{Group: "ibmcloud.ibm.com", Version: "v1alpha1", Resource: "bindings"}

var bindingsKind = schema.GroupVersionKind{Group: "ibmcloud.ibm.com", Version: "v1alpha1", Kind: "Binding"}
