...
import (
	...
	versioned "github.com/ibm/cloud-operators/pkg/client/clientset/versioned"
	internalinterfaces "github.com/ibm/cloud-operators/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/ibm/cloud-operators/pkg/client/listers/ibmcloud/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.IbmcloudV1alpha1().Bindings(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.IbmcloudV1alpha1().Bindings(namespace).Watch(options)
			},
		},
		&ibmcloudv1alpha1.Binding{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *bindingInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&ibmcloudv1alpha1.Binding{}, f.defaultInformer)
}
